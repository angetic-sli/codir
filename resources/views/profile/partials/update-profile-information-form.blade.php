<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="prenoms" name="prenoms" type="text" class="mt-1 block w-full" :value="old('prenoms', $user->prenoms)" autocomplete="given-name" />
            <x-input-error class="mt-2" :messages="$errors->get('prenoms')" />
        </div>

        <div>
            <x-input-label for="fonction" :value="__('Fonction')" />
            <x-text-input id="fonction" name="fonction" type="text" class="mt-1 block w-full" :value="old('fonction', $user->fonction)" />
